...
import 'package:skribbl_game/home_screen.dart';
import 'package:skribbl_game/models/touch_points.dart';
import 'package:skribbl_game/sidebar/player_scoreboard_drawer.dart';
import 'package:skribbl_game/waiting_lobby_screen.dart';
        ...
        builder: (context) => AlertDialog(
          ...
          content: SingleChildScrollView(
            ...
            onColorChanged: (color) {
              ...
              String valueString = colorToHex(color).toLowerCase();
              print(colorString);
              print(valueString);
              Map map = {
                'color': valueString,
